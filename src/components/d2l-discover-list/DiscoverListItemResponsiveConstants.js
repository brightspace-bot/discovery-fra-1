...
/* @polymerMixin */
const DiscoverListItemResponsiveConstantsImpl = (superClass) => class extends superClass {
...
export const DiscoverListItemResponsiveConstants = dedupingMixin(DiscoverListItemResponsiveConstantsImpl);
